...
if __name__ == "__main__":
    ...
    npy_path = '/home/diego/Desktop/FirePrediction/server/utils/examples/chile_tile_(6656, 7168).npy'  # Replace with your file
    ...
    create_geotiff_from_pickle_metadata(
        ...
        output_path='/home/diego/Desktop/FirePrediction/server/utils/examples/chile_tile_(6656, 7168).tif',
        nodata=0  # Adjust based on your data
    )

    # 4. Verify the result
    verify_created_geotiff('/home/diego/Desktop/FirePrediction/server/utils/examples/chile_tile_(6656, 7168).tif')